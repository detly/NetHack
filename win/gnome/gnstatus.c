...
GtkWidget* ghack_init_status_window ()
{
    ...
    if (!redStyle) {
      ...
      gtk_style_set_font(bigRedStyle, gdk_font_load("-misc-fixed-*-*-*-*-20-*-*-*-*-*-*-*"));
      gtk_style_set_font(bigGreenStyle, gdk_font_load("-misc-fixed-*-*-*-*-20-*-*-*-*-*-*-*"));
      gtk_style_set_font(bigStyle, gdk_font_load ("-misc-fixed-*-*-*-*-20-*-*-*-*-*-*-*"));
    }
